...
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.7.0](https://github.com/kagent-dev/kagent/releases/tag/v0.7.0), today) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
