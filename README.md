...
- [clear-route/vault-spec-driven-terraform-testing-framework](https://github.com/clear-route/vault-spec-driven-terraform-testing-framework) - A POC showcasing how to use Terraforms testing framework for YAML spec driven testing of HashiCorp Vault (6 days ago)
...
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.9.1](https://github.com/kagent-dev/kagent/releases/tag/v0.9.1), 2 days ago) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
- [patrickchugh/terravision](https://github.com/patrickchugh/terravision) ([v0.39.0](https://github.com/patrickchugh/terravision/releases/tag/v0.39.0), 3 days ago) - Terravision creates Professional Cloud Architecture Diagrams from your Terraform code automatically. Supports AWS, Google and Azure.
