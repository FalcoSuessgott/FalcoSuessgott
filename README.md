...
- [go-co-op/gocron](https://github.com/go-co-op/gocron) ([v2.18.0](https://github.com/go-co-op/gocron/releases/tag/v2.18.0), 1 day ago) - Easy and fluent Go cron scheduling. This is a fork from https://github.com/jasonlvhit/gocron
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.7.4](https://github.com/kagent-dev/kagent/releases/tag/v0.7.4), 2 days ago) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
...
- [feat(opts): add WithWebSocketDisabled and WithAPIDisabled Server Options](https://github.com/go-co-op/gocron-ui/pull/8) on [go-co-op/gocron-ui](https://github.com/go-co-op/gocron-ui) (1 day ago)
- [fix(typo): fix examples dir typo](https://github.com/go-co-op/gocron-ui/pull/7) on [go-co-op/gocron-ui](https://github.com/go-co-op/gocron-ui) (1 day ago)
