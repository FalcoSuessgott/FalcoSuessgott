...
- [stmcginnis/gofish](https://github.com/stmcginnis/gofish) ([v0.17.0](https://github.com/stmcginnis/gofish/releases/tag/v0.17.0), 1 day ago) - Gofish is a Golang client library for DMTF Redfish and SNIA Swordfish interaction.
- [kubefirst/gitops-template](https://github.com/kubefirst/gitops-template) ([v2.4.6](https://github.com/kubefirst/gitops-template/releases/tag/v2.4.6), 5 days ago) - a template of gitops infrastucture for consumption by kubefirst users
