...
- [FalcoSuessgott/vault-kubernetes-kms](https://github.com/FalcoSuessgott/vault-kubernetes-kms) ([v0.0.7](https://github.com/FalcoSuessgott/vault-kubernetes-kms/releases/tag/v0.0.7), 1 day ago) - Encrypt Kubernetes Secrets using Hashicorp Vault as the KMS Provider
- [stmcginnis/gofish](https://github.com/stmcginnis/gofish) ([v0.19.0](https://github.com/stmcginnis/gofish/releases/tag/v0.19.0), 4 days ago) - Gofish is a Golang client library for DMTF Redfish and SNIA Swordfish interaction.
...
- [fix(version): output version if flag passed](https://github.com/FalcoSuessgott/vault-kubernetes-kms/pull/84) on [FalcoSuessgott/vault-kubernetes-kms](https://github.com/FalcoSuessgott/vault-kubernetes-kms) (2 days ago)
