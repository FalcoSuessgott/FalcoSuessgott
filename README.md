...
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.9.4](https://github.com/kagent-dev/kagent/releases/tag/v0.9.4), 2 weeks ago) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
- [patrickchugh/terravision](https://github.com/patrickchugh/terravision) ([v0.39.0](https://github.com/patrickchugh/terravision/releases/tag/v0.39.0), 1 month ago) - Terravision creates Professional Cloud Architecture Diagrams from your Terraform code automatically. Supports AWS, Google and Azure.
...
- [fix(kvv2): correctly trim suffix from vault_kv_secret_backend_v2](https://github.com/hashicorp/terraform-provider-vault/pull/2915) on [hashicorp/terraform-provider-vault](https://github.com/hashicorp/terraform-provider-vault) (2 days ago)
