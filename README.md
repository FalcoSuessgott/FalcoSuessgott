...
- [kubefirst/gitops-template](https://github.com/kubefirst/gitops-template) ([v2.4.10](https://github.com/kubefirst/gitops-template/releases/tag/v2.4.10), 1 day ago) - a template of gitops infrastucture for consumption by kubefirst users
- [YaleUniversity/packer-plugin-goss](https://github.com/YaleUniversity/packer-plugin-goss) ([v3.2.11](https://github.com/YaleUniversity/packer-plugin-goss/releases/tag/v3.2.11), 6 days ago) - Goss Provisioner for Packer
