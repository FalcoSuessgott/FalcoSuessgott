...
- [kubefirst/gitops-template](https://github.com/kubefirst/gitops-template) ([v2.4.10](https://github.com/kubefirst/gitops-template/releases/tag/v2.4.10), 5 days ago) - a template of gitops infrastucture for consumption by kubefirst users
...
- [fix(templates): improve template engine and update docs](https://github.com/FalcoSuessgott/vkv/pull/274) on [FalcoSuessgott/vkv](https://github.com/FalcoSuessgott/vkv) (1 day ago)
- [fix(utils): do not use a pointer when transforming maps](https://github.com/FalcoSuessgott/vkv/pull/272) on [FalcoSuessgott/vkv](https://github.com/FalcoSuessgott/vkv) (2 days ago)
- [feat(export): add --export-upper and --export-include-path options](https://github.com/FalcoSuessgott/vkv/pull/271) on [FalcoSuessgott/vkv](https://github.com/FalcoSuessgott/vkv) (4 days ago)
