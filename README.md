...
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.6.16](https://github.com/kagent-dev/kagent/releases/tag/v0.6.16), 3 days ago) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
- [go-co-op/gocron](https://github.com/go-co-op/gocron) ([v2.16.6](https://github.com/go-co-op/gocron/releases/tag/v2.16.6), 5 days ago) - Easy and fluent Go cron scheduling. This is a fork from https://github.com/jasonlvhit/gocron
