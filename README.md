...
- [FalcoSuessgott/vkv](https://github.com/FalcoSuessgott/vkv) ([v0.9.2](https://github.com/FalcoSuessgott/vkv/releases/tag/v0.9.2), 2 days ago) - vkv enables you to list, compare, move, import, document, backup &amp; encrypt secrets from a HashiCorp Vault KV engine
...
- [chore(cli): switch to fang](https://github.com/FalcoSuessgott/vkv/pull/375) on [FalcoSuessgott/vkv](https://github.com/FalcoSuessgott/vkv) (2 days ago)
