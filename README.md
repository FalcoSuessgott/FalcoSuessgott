...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.14.1](https://github.com/hashicorp/vault/releases/tag/v1.14.1), 3 days ago) - A tool for secrets management, encryption as a service, and privileged access management
- [ansible-community/ansible-vault](https://github.com/ansible-community/ansible-vault) ([2023.07.01](https://github.com/ansible-community/ansible-vault/releases/tag/2023.07.01), 3 weeks ago) - :key: Ansible role for Hashicorp Vault
...
- [feat(ldap): add backend attribute for specifying existing auth backend](https://github.com/hashicorp/terraform-provider-vault/pull/1951) on [hashicorp/terraform-provider-vault](https://github.com/hashicorp/terraform-provider-vault) (3 days ago)
