...
- [ilijamt/vault-plugin-secrets-gitlab](https://github.com/ilijamt/vault-plugin-secrets-gitlab) ([v0.3.2](https://github.com/ilijamt/vault-plugin-secrets-gitlab/releases/tag/v0.3.2), 5 days ago) - Vault Plugin for Gitlab Access Tokens
...
- [feat(tests): test cmd package](https://github.com/FalcoSuessgott/vault-kubernetes-kms/pull/48) on [FalcoSuessgott/vault-kubernetes-kms](https://github.com/FalcoSuessgott/vault-kubernetes-kms) (3 days ago)
- [feat(plugin): add plugin unit tests](https://github.com/FalcoSuessgott/vault-kubernetes-kms/pull/41) on [FalcoSuessgott/vault-kubernetes-kms](https://github.com/FalcoSuessgott/vault-kubernetes-kms) (6 days ago)
