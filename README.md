...
- [kubefirst/gitops-template](https://github.com/kubefirst/gitops-template) ([v2.4.7](https://github.com/kubefirst/gitops-template/releases/tag/v2.4.7), 3 days ago) - a template of gitops infrastucture for consumption by kubefirst users
