...
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.8.0-beta9](https://github.com/kagent-dev/kagent/releases/tag/v0.8.0-beta9), 3 days ago) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
...
- [fix(manifest-experiment): strip data from secret during normalization](https://github.com/hashicorp/terraform-provider-helm/pull/1766) on [hashicorp/terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) (4 weeks ago)
