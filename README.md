...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.14.1](https://github.com/hashicorp/vault/releases/tag/v1.14.1), 1 day ago) - A tool for secrets management, encryption as a service, and privileged access management
...
- [feat(ldap): add backend attribute for specifying existing auth backend](https://github.com/hashicorp/terraform-provider-vault/pull/1951) on [hashicorp/terraform-provider-vault](https://github.com/hashicorp/terraform-provider-vault) (1 day ago)
