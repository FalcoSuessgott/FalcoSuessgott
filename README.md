...
- [FalcoSuessgott/vault-kubernetes-kms](https://github.com/FalcoSuessgott/vault-kubernetes-kms) ([v0.1.0](https://github.com/FalcoSuessgott/vault-kubernetes-kms/releases/tag/v0.1.0), today) - Encrypt Kubernetes Secrets using Hashicorp Vault as the KMS Provider
...
- [chore(k8s): remove kubernetes auth](https://github.com/FalcoSuessgott/vault-kubernetes-kms/pull/88) on [FalcoSuessgott/vault-kubernetes-kms](https://github.com/FalcoSuessgott/vault-kubernetes-kms) (today)
