...
- [FalcoSuessgott/golang-cli-template](https://github.com/FalcoSuessgott/golang-cli-template) ([v0.1.0](https://github.com/FalcoSuessgott/golang-cli-template/releases/tag/v0.1.0), today) - A general purpose project template for golang CLI applications for  Github and Gitlab
