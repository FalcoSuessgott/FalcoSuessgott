...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.11.11](https://github.com/hashicorp/vault/releases/tag/v1.11.11), 6 days ago) - A tool for secrets management, encryption as a service, and privileged access management
...
- [feat(lb): support specifiying an external loadbalancer](https://github.com/xunleii/terraform-module-k3s/pull/126) on [xunleii/terraform-module-k3s](https://github.com/xunleii/terraform-module-k3s) (4 weeks ago)
