...
- [FalcoSuessgott/vops](https://github.com/FalcoSuessgott/vops) ([v0.0.7](https://github.com/FalcoSuessgott/vops/releases/tag/v0.0.7), 2 days ago) - A HashiCorp Vault cluster management tool
- [kubermatic/kubeone](https://github.com/kubermatic/kubeone) ([v1.4.14](https://github.com/kubermatic/kubeone/releases/tag/v1.4.14), 3 days ago) - Kubermatic KubeOne automate cluster operations on all your cloud, on-prem, edge, and IoT environments.  
...
- [fix(ldap): update ldap description](https://github.com/hashicorp/terraform-provider-vault/pull/1852) on [hashicorp/terraform-provider-vault](https://github.com/hashicorp/terraform-provider-vault) (1 day ago)
- [feat(keyfile): make keyfile optional](https://github.com/FalcoSuessgott/vops/pull/28) on [FalcoSuessgott/vops](https://github.com/FalcoSuessgott/vops) (2 days ago)
