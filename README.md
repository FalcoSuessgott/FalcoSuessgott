...
- [go-co-op/gocron](https://github.com/go-co-op/gocron) ([v2.17.0](https://github.com/go-co-op/gocron/releases/tag/v2.17.0), 4 days ago) - Easy and fluent Go cron scheduling. This is a fork from https://github.com/jasonlvhit/gocron
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.6.19](https://github.com/kagent-dev/kagent/releases/tag/v0.6.19), 6 days ago) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
...
- [fix(version): only stop port-forwarding when successfully connected](https://github.com/kagent-dev/kagent/pull/1014) on [kagent-dev/kagent](https://github.com/kagent-dev/kagent) (2 days ago)
