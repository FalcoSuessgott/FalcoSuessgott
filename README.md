...
- [patrickchugh/terravision](https://github.com/patrickchugh/terravision) ([v0.42.0](https://github.com/patrickchugh/terravision/releases/tag/v0.42.0), 2 days ago) - Terravision creates Professional Cloud Architecture Diagrams from your Terraform code automatically. Supports AWS, Google and Azure.
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.9.6](https://github.com/kagent-dev/kagent/releases/tag/v0.9.6), 3 days ago) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
