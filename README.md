...
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.7.1](https://github.com/kagent-dev/kagent/releases/tag/v0.7.1), today) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
