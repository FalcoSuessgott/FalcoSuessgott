...
- [kagent-dev/kagent](https://github.com/kagent-dev/kagent) ([v0.9.9](https://github.com/kagent-dev/kagent/releases/tag/v0.9.9), today) - Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord
